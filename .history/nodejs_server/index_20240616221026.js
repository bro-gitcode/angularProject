...
app.post('/staff',(req,res)=>{
    ...
    let sql = "INSERT INTO project SET first_name=?,last_name=?,day_of_birth=?,sect=?,area=?";
...
app.put('/staff/:id',(req,res)=>{
    ...
    let id = req.params.id;
    let {first_name,last_name,day_of_birth,sect,area} = req.body;
    let sql = "UPDATE project SET first_name,last_name,day_of_birth,sect,area WHERE id=?";
    db.query(sql,[name_project,create_date,price,leader,member.join(','),id],(err,d)=>{
        if(err) res.json({'message':"Can't update !" + err});
        else res.json({'message':'Updated !'});
    })
